...
describe('verify: ', () => {
  ...
  describe('isPhone: ', () => {
    it(`isPhone('15188888354') should return true`, () => {
      expect(isPhone('15188888354')).toBeTruthy()
    })
    it(`isPhone('8615188888354') should return true`, () => {
      expect(isPhone('8615188888354')).toBeTruthy()
    })
    it(`isPhone('8867333') should return false`, () => {
      expect(isPhone('8867333')).toBeFalsy()
    })
  })
  ...
  describe('isUndefined: ', () => {
    ...
    it(`isUndefined(1) should return false`, () => {
      expect(isUndefined(1)).toBeFalsy()
    })
    it(`isUndefined(false) should return false`, () => {
      expect(isUndefined(false)).toBeFalsy()
    })
    it(`isUndefined([1,2,3]) should return false`, () => {
      expect(isUndefined([1, 2, 3])).toBeFalsy()
    })
    it(`isUndefined(Symbol(1)) should return false`, () => {
      expect(isUndefined(Symbol(1))).toBeFalsy()
    })
    it(`isUndefined(BigInt(9007199254740991)) should return false`, () => {
      expect(isUndefined(BigInt(9007199254740991))).toBeFalsy()
    })
    it(`isUndefined(function(){}) should return false`, () => {
